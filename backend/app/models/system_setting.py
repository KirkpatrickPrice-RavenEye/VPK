...
class ApplicationSetting(Base, TimestampMixin):
    ...
    teams_webhook_url_encrypted = Column(Text)
    ...
    # Teams Webhook URL property
    @property
    def teams_webhook_url(self) -> str:
        return self._decrypt_value(self.teams_webhook_url_encrypted)

    @teams_webhook_url.setter
    def teams_webhook_url(self, value: str):
        self.teams_webhook_url_encrypted = self._encrypt_value(value)
